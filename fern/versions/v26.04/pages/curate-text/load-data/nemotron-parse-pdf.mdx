...
What comes out is one row per element the model found, in roughly reading order — not yet a document. To reassemble those elements into readable markdown, with paragraphs rejoined across columns and pages, figures beside their captions, and page furniture dropped, see [PDF to Interleaved Markdown](/curate-text/process-data/interleaved/pdf-markdown).
