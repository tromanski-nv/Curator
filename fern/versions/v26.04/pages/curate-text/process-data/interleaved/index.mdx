...
<Card title="PDF to Interleaved Markdown" href="/curate-text/process-data/interleaved/pdf-markdown">
Parse PDFs with Nemotron-Parse, then reassemble the elements into a readable markdown document
nemotron-parse
pdf
markdown
</Card>
