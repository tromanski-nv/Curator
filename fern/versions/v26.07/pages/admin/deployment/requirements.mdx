...
<Warning>
**Python 3.10 support was removed in NeMo Curator 26.07.** 26.04 was the last release to support Python 3.10. Standardize production environments on Python 3.11, 3.12, or 3.13 before upgrading. See the [26.07 migration checklist](/about/release-notes/26-07-migration#1-upgrade-python) for details.
</Warning>
...
### Core Dependencies
- Python 3.11+ with required packages for distributed computing
