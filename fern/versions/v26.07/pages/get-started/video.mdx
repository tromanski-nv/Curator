...
<Note>
On GPUs without NVENC hardware, such as A100 and H100, use `--transcode-encoder libvpx-vp9` or install software H.264 support and use `--transcode-encoder libopenh264`.
</Note>
