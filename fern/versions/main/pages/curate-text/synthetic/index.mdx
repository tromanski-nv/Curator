...
2. **NeMo Curator with text extras**
   ...
   [installation guide](/get-started/installation). Standard pip is not
   supported for this extra.
...
<Card title="Nemotron OCR" href="/curate-text/synthetic/nemotron-ocr">
