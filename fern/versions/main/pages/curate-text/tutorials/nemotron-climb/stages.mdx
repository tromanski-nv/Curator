...
- `--fit-data-fraction` samples that fraction of whole embedding files while assigning all documents.
  When omitted, Parquet fitting is sized from free GPU memory, while JSONL fits all input files.
